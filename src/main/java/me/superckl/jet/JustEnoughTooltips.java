...
@Mod(modid = ModData.MOD_ID, name = ModData.NAME, version = ModData.VERSION, acceptableRemoteVersions = "*", guiFactory = "me.superckl.jet.gui.JETGuiFactory", dependencies = "required-after:JEI@[2.16.2.78,)")
